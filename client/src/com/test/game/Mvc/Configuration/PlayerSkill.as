package com.test.game.Mvc.Configuration
{
	...
	public class PlayerSkill extends BaseConfiguration
	{
		...
		public function copy() : PlayerSkill{
			var data:PlayerSkill = new PlayerSkill();
			data.id = id;
			data.sid = sid;
			data.name = name;
			data.source = source;
		...
		public function get shake() : int{
			return _anti["shake"];
		}
		public function set shake(value:int) : void{
			_anti["shake"] = value;
		}
