package com.test.game.Mvc.Configuration
{
	...
	public class HideMission extends BaseConfiguration
	{
		
		public function HideMission()
		{
			super();
		...
		override public function assign(data:Object):void{
			...
			rules_number = data.rules_number;
		...
		public function get rules_number() : int{
			return _anti["rules_number"];
		}
		public function set rules_number(value:int) : void{
			_anti["rules_number"] = value;
		}
