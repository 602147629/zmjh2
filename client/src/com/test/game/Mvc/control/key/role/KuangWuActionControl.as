package com.test.game.Mvc.control.key.role
{
	...
	public class KuangWuActionControl extends BaseControl
	{
		...
		public function KuangWuActionControl()
		{
			super();
		...
		public static function getIns():KuangWuActionControl{
			return Singleton.getIns(KuangWuActionControl);
		}
