package com.test.game.Mvc.control.key
{
	...
	public class GotoFunnyBattleControl extends BaseControl
	{
		public function GotoFunnyBattleControl()
		{
			super();
		}
		...
		public function goToBattle():void{
			...
			ViewFactory.getIns().initView(FunnyMapView);
		}
		...
		public function initBattleView() : void{
			...
			BmdViewFactory.getIns().initView(FunnyBossSceneView);
		...
		public function leaveBattle() : void{
			...
			(BmdViewFactory.getIns().getView(FunnyBossSceneView) as FunnyBossSceneView).gameRelive();
			...
			BmdViewFactory.getIns().destroyView(FunnyBossSceneView);
			ViewFactory.getIns().destroyView(FunnyMapView);
		...
		public function gameRelive() : void{
			...
			(ViewFactory.getIns().getView(FunnyMapView) as FunnyMapView).mapBitmap.filters = null;
