package com.test.game.Modules.MainGame.Map
{
	...
	public class HeroMapView extends BaseView
	{
		private var _hsv:HeroSceneView;
		//地图
		...
		override public function init():void{
			...
			arr = arr.concat([
				AssetsUrl.getAssetObject(AssetsConst.HERO_MAP),
		...
		public function setMap() : void{
			...
			mapBitmap.data.bitmapData = AUtils.getNewObj("HeroMap") as BitmapData;
			mapBitmap.x = -50;
			mapBitmap.y = -80;
		...
		override public function setParams():void{
			...
			(ControlFactory.getIns().getControl(GotoHeroBattleControl) as GotoHeroBattleControl).initBattleView();
		}
		
		public function moveMap():void{
			var player:PlayerEntity;
			_hsv = BmdViewFactory.getIns().getView(HeroSceneView) as HeroSceneView;
			_limitLeft = 0;
