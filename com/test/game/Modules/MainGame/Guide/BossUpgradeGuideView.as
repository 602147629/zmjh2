package com.test.game.Modules.MainGame.Guide
{
	...
	public class BossUpgradeGuideView extends BaseView
	{
		public function BossUpgradeGuideView()
		{
			super();
		}
		...
		override public function setParams():void{
			if(layer == null){
				...
				_guideMC = GuideManager.getIns().getGuideMCByName("GuideBossUpgrade", 0, 0);
			}
