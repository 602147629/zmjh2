package com.test.game.Mvc.control.key.role
{
	...
	public class KuangWuSimpleActionControl extends BaseControl
	{
		...
		public function KuangWuSimpleActionControl()
		{
			super();
		...
		public static function getIns():KuangWuSimpleActionControl{
			return Singleton.getIns(KuangWuSimpleActionControl);
		}
