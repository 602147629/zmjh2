package com.test.game.Mvc.control.key.role
{
	...
	public class XiaoYaoActionControl extends BaseControl
	{
		...
		public function XiaoYaoActionControl()
		{
			super();
		...
		public static function getIns():XiaoYaoActionControl{
			return Singleton.getIns(XiaoYaoActionControl);
		}
