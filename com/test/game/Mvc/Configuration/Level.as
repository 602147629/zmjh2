package com.test.game.Mvc.Configuration
{
	...
	public class Level extends BaseConfiguration
	{
		...
		public function get strengthen() : String{
			return _anti["strengthen"];
		}
		public function set strengthen(value:String) : void{
			_anti["strengthen"] = value;
		}
		...
		public function get skill_rate() : Number{
			return _anti["skill_rate"];
		}
		public function set skill_rate(value:Number) : void{
			_anti["skill_rate"] = value;
		}
